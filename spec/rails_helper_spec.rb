...
describe JqueryTag::RailsHelper do
  ...
  context "in production environment" do
    ...
    it "uses the google CDN path" do
      expects_include_with ['//ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js']
      jquery_tag
    end
    ...
    it "uses the google CDN path for the jquery ui script" do
      expects_include_with ['//ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js', '//ajax.googleapis.com/ajax/libs/jqueryui/1.8.13/jquery-ui.min.js']
      jquery_tag :ui => true
    end
  end
end